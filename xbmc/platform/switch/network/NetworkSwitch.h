...
class CNetworkSwitch;

class CNetworkInterfaceSwitch : public CNetworkInterface
{
public:
   CNetworkInterfaceSwitch(CNetworkSwitch* network, std::string interfaceName, char interfaceMacAddrRaw[6]);
   ~CNetworkInterfaceSwitch(void) override;
...
public:
   ...
   friend class CNetworkInterfaceSwitch;
